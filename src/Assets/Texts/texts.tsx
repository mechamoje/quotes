...
export const Texts: ArrayProps[] = [
    {
        id: 1,
        feeling: "happy",
        title: "sad",
        author: "Fulano",
        text: "Me definiram céu: puramente, sou azul, mas tenho meus dias de cinza."
    },
    {
        id: 2,
        feeling: "sad",
    ...
    },
    {
        ...
        title: "love",
        author: "Fulano",
        text: "É, e parece que quando eu não estou com você eu sei exatamente o que fazer. E de repente lá estou eu, sozinha de novo, na cama, pensando mais uma vez em como te falar que eu não quero mais nada, que eu me cansei da tua bagunça, da tua insegurança e dessa tua falta de certeza perseguidora. Mas aí mais um dia passa e você chega com aquele sorriso bobo de como quem não quer nada me ganhando de jeito e me fazendo não saber o que vai acontecer depois, chega você com aquela fala mansa e destroi todos os planos que eu fiz na ultima noite, é como se o teu sorriso fosse minha zona de perigo, e teus olhos minha maior fraqueza, como se contra mim fosse a mais mortal de todas as armas. Todo esforço de horas e horas de pensamentos jogados no lixo com um simples sorriso. Parece que com você vale a pena apostar todas as fichas num destino meio incerto."
    },
    {
        id: 8,
        feeling: "love",
        title: "Algo",
        author: "Fulano",
        text: "Quem me dera, te encontrar de novo na mesma esquina, com o mesmo paletó de sempre e com a mesma cara de bêbado segurando um possível “bilhete premiado”. Nunca entendi muito bem essa sua paixão por jogos e apostas. Reparo em como você dobra as meias na gaveta, bem dobradas, em contraste dos tons mais claro, aos mais escuros. E também em como você tem mania de limpeza, sempre me irritei com essa sua bobagem de querer que a casa esteja sempre um brinco. Porém com você não era assim, dentro de você sempre tinha uma sombra de dúvida, insegurança, uma certa bagunça e confusão nos sentimentos. Não entendo essas suas manias mas sabe… quer voltar? Senta comigo, me chama num canto, me explica suas coisas, me conta como foi seu dia no trabalho, reclama do seu chefe. Prometo prestar atenção em cada frase, vamos beber alguma coisa, fingir que nunca reparei tanto em seus movimentos, ou na leveza em que seus lábios se movem enquanto tenta me convencer que whisky é melhor que vinho. Que tal começar tudo de novo? Qual seu nome mesmo?"
    },
    {
        id: 9,
        feeling: "sad",
        title: "Algo",
        author: "Fulano",
        text: "Mas sabe…. Não é saudade não. Só se sente saudade do que algum dia já te pertenceu. É falta mesmo. Falta de ter alguém comigo, alguém pra me dá carinho. Um carinho que só pode vir de você. Um espaço que só você pode preencher."
    },
    {
        id: 10,
        feeling: "love",
    ...
    },
    {
        ...
        title: "Algo",
        author: "Fulano",
        text: "Mas a verdade é que não da pra fugir. Você nega, diz pra sí mesmo que não está apaixonada, mas você sabe que está, quando é amor é assim mesmo. Quando você escuta a música mais linda, é nele que você pensa. Quando você acorda, é ele seu primeiro pensamento do dia. E até agora, enquanto está lendo isso, eu posso apostar todos os trocados que tenho aqui, é a imagem dele que você tem em mente. Pode negar, pode continuar negando o quanto quiser. Você se conhece, sabe que está querendo, sabe que está precisando de um carinho, um afago. Então, menina, aceita de uma vez que é amor, porque no fundo, você sabe que é."
    },
    {
        id: 12,
        feeling: "love",
        title: "Algo",
        author: "Fulano",
        text: "Juro como tentei demonstrar, juro. Mas nenhuma palavra era capaz de descrever como eu me sentia, nenhuma das milhões de palavras existentes conseguiam definir o que eu sentia exatamente. Quero te contar, quero falar que a confusão que rola aqui dentro é toda culpa sua, mas faltam-me palavras. Poderia usar todos os adjetivos, inimagináveis palavras de amor mas nada ia conseguir chegar perto do que eu realmente sinto, porque do jeito que está, meu amor, “eu te amo” já me parece insuficiente."
    }
]